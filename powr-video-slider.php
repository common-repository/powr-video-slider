<?php
    ...
    Plugin URI: https://www.powr.io/plugins/video-slider
    ...
    */
    ...
    function powr_video_slider_options() {
      if(powr_local_mode()){//Determine JS url:
        $redirect_url = 'https://localhost:3000/wp-create/video-slider';
      }else{
        $redirect_url = 'https://www.powr.io/wp-create/video-slider';
      }
